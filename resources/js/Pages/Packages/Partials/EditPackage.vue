<template>
    <div>
        ...
        <Modal :show="showModal" @close="closeModal" maxWidth="xl" closeable>
            <template #default>
                <div class="p-6">
                    <h2 class="text-lg font-medium text-gray-900">Modal Title {{ packageItem.code }}</h2>

                    <form @submit.prevent="editPackage" class="mt-6">
                        <div>
                            <InputLabel for="code" v-value="packageItem.code" class="sr-only">Code</InputLabel>
                        ...
                        <div class="mt-3">
                            ...
                            <MarkdownEditor v-model="form.info" v-value="packageItem.info" editor-class="!min-h-[120px]" />
