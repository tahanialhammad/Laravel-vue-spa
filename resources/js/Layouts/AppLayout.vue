                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <template v-else>
                                <Link :href="route('login')"
                                    class="rounded-full px-6 py-2 text-slate-100 ring-1 ring-indigo-700 transition hover:text-white/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white me-2">
                                Log in
                                </Link>

                                <Link :href="route('register')"
                                    class="rounded-full px-6 py-2 text-slate-100 ring-1 ring-indigo-700 transition hover:text-white/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                Register
                                </Link>
                            </template>
                        </div>
